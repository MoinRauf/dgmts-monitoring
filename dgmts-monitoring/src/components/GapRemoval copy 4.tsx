...
//         link.download = `${selectedColumn1} vs ${selectedColumn2}.png`;
//         link.href = dataUrl;
//         link.click();
//       });
//     }
...
//     const graphValues1 = selectedData1.map((value, index) => ({
//       index,
//       value: value || 0, // Handle missing values
//     }));

//     const graphValues2 = selectedData2.map((value, index) => ({
//       index,
//       value: value || 0, // Handle missing values
//     }));

//     const graphValues3 = selectedData3.map((value, index) => ({
//       index,
//       value: value || 0, // Handle missing values
//     }));

//     setGraphData1(graphValues1);
//     setGraphData2(graphValues2);
//     setGraphData3(graphValues3);
//   };
